...
from feature_extraction import detect_features
import numpy as np
import cv2
import itertools

def match_template(imgname, templatename, threshold, cutoff):
	
	img = cv2.imread(imgname)
	template = cv2.imread(templatename)

	[kpi, di] = detect_features(imgname, threshold)
	[dpt, dt] = detect_features(templatename, threshold)
...
def main():
	img1 = "/home/yihong/Desktop/input1.tif"
	img2 = "/home/yihong/Desktop/input2.tif"
	match_template(img1, img2, 5, 20)
